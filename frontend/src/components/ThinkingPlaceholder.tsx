 ...
 *
 * Replaces the old top-of-view WaitingIndicator for the "bot is busy" state.
  ...
  return (
    <div className="message-sheet message-assistant flex gap-3" role="status" aria-label={`${botName} is thinking`}>
      ...
      <div className="min-w-0 flex-1">
        <div className="message-meta">{botName}</div>
        <div className="flex items-center gap-1.5 text-sm text-[#687067]">
          <span>is thinking</span>
          <span className="inline-flex gap-0.5" aria-hidden>
            <span className="thinking-dot h-1 w-1 rounded-full bg-[#687067]/60" style={{ animationDelay: "0ms" }} />
            <span className="thinking-dot h-1 w-1 rounded-full bg-[#687067]/60" style={{ animationDelay: "200ms" }} />
            <span className="thinking-dot h-1 w-1 rounded-full bg-[#687067]/60" style={{ animationDelay: "400ms" }} />
          </span>
        </div>
      </div>
    </div>
