...
const row = ({ isActive }: { isActive: boolean }) =>
  `relative flex h-9 items-center gap-2.5 rounded-ui px-2 text-[13px] leading-none transition-colors ${
    isActive
        ...
        {!collapsed && (
          <>
            ...
            <div className="scrollbar-subtle flex-1 overflow-y-auto px-2 py-3">
              ...
              <div className="mt-3">
                <NavLink to="/threads" end className="flex h-9 items-center justify-center gap-1.5 rounded-ui border border-accent bg-accent px-3 text-[13px] font-medium leading-none text-on-accent transition-colors hover:border-accent-strong hover:bg-accent-strong">
